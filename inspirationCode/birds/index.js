const Birds = function () {
    ...
    const drawBird = function (bird) {
        ...
        const size = (width + height) / 200 * pos.z * z.current;
        const atan = Math.atan2(bird.move.y * height, bird.move.x * width);

        engine.lineWidth = 1;

        const p = function (rad, customSize) {
            return {
